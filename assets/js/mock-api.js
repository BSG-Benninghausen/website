...
(function () {
  ...
  const CLUB_FIELDS = [
    ...
    { key: "phone", label: "Telefon (Impressum)", type: "text" },
    { key: "register_court", label: "Vereinsregister · Amtsgericht (Impressum)", type: "text" },
    { key: "register_number", label: "Vereinsregister · Nummer (VR, Impressum)", type: "text" },
